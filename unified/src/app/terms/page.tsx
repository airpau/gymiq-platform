  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900 antialiased">
      ...
      <main className="mx-auto max-w-3xl px-5 pb-24 pt-12 text-[15px] leading-relaxed text-zinc-700">
        <p className="text-xs font-medium uppercase tracking-[0.14em] text-emerald-700">Terms</p>
        <h1 className="mt-2 text-3xl font-semibold tracking-tight text-zinc-900">Terms of service</h1>
        <p className="mt-2 text-sm text-zinc-500">Last updated {UPDATED}. GymIQ AI Ltd, United Kingdom.</p>
        ...
        <P>gymIQ is sold per club at a set monthly fee, currently £395 excluding VAT, with no setup fee and no usage charges. The fee is billed monthly in advance. Either side can end the subscription with one month&apos;s written notice. We provide the morning brief, the staff task board, the failed payment routine, the audits and the cash forecast described on the website, using read only access to the club&apos;s gym management system and, where connected, its bank feed through a regulated open banking provider.</P>

        <H>What we need from you</H>
        <P>A login to your gym management system with the access needed to read reports, ideally a dedicated read only user; renewal of the open banking consent when it expires; and prompt notice of anything that changes how the club operates (pricing, payout arrangements, staff). Staff actions taken from the board remain the club&apos;s decisions.</P>
        ...
        <H>Data</H>
        <P>Member data belongs to the club. We process it only to provide the service, under our <Link href="/privacy" className="text-emerald-700 hover:text-emerald-800">privacy policy</Link> and a data processing agreement. On termination we delete the club&apos;s data within 30 days unless the law requires otherwise.</P>
        ...
        <p className="mt-10 text-xs text-zinc-500">Questions: paul@gymiq.ai</p>
      </main>
    </div>
  )
}
