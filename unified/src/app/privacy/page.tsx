  ...
  return (
    <div className="min-h-screen bg-white text-ink antialiased">
      ...
      <main className="mx-auto max-w-3xl px-5 pb-24 pt-12 text-[15px] leading-relaxed text-ink-3">
        ...
        <H>Your rights</H>
        <P>Under UK GDPR you can ask for a copy of the data we hold about you, ask us to correct or delete it, object to processing based on our legitimate interests, ask us to restrict it, and withdraw consent at any time (for cookies, through cookie settings; for marketing, by replying to any email). Email paul@gymiq.ai and we will respond within one month. If you are a gym member and your gym uses gymIQ, please contact your gym first, as they are the controller of your membership data. You can complain to the Information Commissioner&apos;s Office at ico.org.uk.</P>
