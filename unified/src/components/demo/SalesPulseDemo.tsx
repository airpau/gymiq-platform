  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-2xl bg-ink p-4 text-paper">
        <p className="font-mono text-[11px] uppercase tracking-wider text-paper/75">Hourly pulse, to the owner&apos;s phone</p>
        <p className="mt-2 min-h-[48px] font-mono text-[13px] leading-relaxed text-paper/92">{alert ?? 'Quiet. Nothing fires while the day is on pace; you only hear about it when something has moved.'}</p>
      </div>
